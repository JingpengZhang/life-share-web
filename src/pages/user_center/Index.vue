    ...
    >
      ...
      <ul class="scroll-box px-4 pt-5 flex flex-col gap-3 overflow-y-scroll">
        ...
        <li class="">
          <div class="nav_item user_center_nav_normal">
            <div class="flex gap-4 items-center">
              <i-box theme="outline" size="24" />
              <span class="">内容管理</span>
            </div>
            <i-right
              class="transition-all duration-500"
              theme="outline"
          ...
          <ul class="transition-all duration-500 overflow-hidden">
            <router-link
              to="/user_center/share"
              class="second_item user_center_nav_normal_second"
              active-class="user_center_nav_active_second"
            >
              <span class="text-3xl">·</span>
              <span class="text-sm">我的分享</span>
            </router-link>
            <router-link
                to="/user_center/ask"
                class="second_item user_center_nav_normal_second"
            ...
            >
              <span class="text-3xl">·</span>
              <span class="text-sm">我的问题</span>
            </router-link>
            <router-link
                to="/user_center/answer"
                class="second_item user_center_nav_normal_second"
                active-class="user_center_nav_active_second"
            >
              <span class="text-3xl">·</span>
              <span class="text-sm">我的回答</span>
            </router-link>
            <router-link
                to="/user_center/book"
                class="second_item user_center_nav_normal_second"
        ...
        <li class="">
          <div class="nav_item user_center_nav_normal">
            <div class="flex gap-4 items-center">
              <i-editor theme="filled" size="24" />
              <span class="">创作中心</span>
            </div>
            <i-right
              class="transition-all duration-500"
              theme="outline"
          ...
          <ul class="transition-all duration-500 overflow-hidden">
            <router-link
              to="/user_center/createshare"
              class="second_item user_center_nav_normal_second"
              active-class="user_center_nav_active_second"
            >
              <span class="text-3xl">·</span>
              <span class="text-sm">生活分享</span>
            </router-link>
            <router-link
                to="/user_center/createask"
                class="second_item user_center_nav_normal_second"
                active-class="user_center_nav_active_second"
            >
              <span class="text-3xl">·</span>
              <span class="text-sm">问答中心</span>
            </router-link>
            <router-link
                to="/user_center/createbook"
                class="second_item user_center_nav_normal_second"
                active-class="user_center_nav_active_second"
            >
              <span class="text-3xl">·</span>
              <span class="text-sm">好书推荐</span>
            </router-link>
            <router-link
                to="/user_center/createlost"
                class="second_item user_center_nav_normal_second"
                active-class="user_center_nav_active_second"
            >
              <span class="text-3xl">·</span>
